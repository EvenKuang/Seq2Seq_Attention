...
# trainIters(encoder1, attn_decoder1, 75000, reverse, print_every=5000) # 75000-n_iters
# trainIters(encoder1, attn_decoder1, 50000, reverse, print_every=5000) 
trainIters(encoder1, attn_decoder1, 100000, reverse, print_every=5000) 
